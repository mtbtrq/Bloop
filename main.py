...
async def stats(ctx):
    ...
    statsembed.add_field(name = f'Commands:', value = f'{len(client.commands)}', inline = False)
...
@client.command()
async def help(ctx):
  helpembed = discord.Embed(title='Help', description='Made with <3 by Supelion.', color = 0x2f3136)
